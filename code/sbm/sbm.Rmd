---
title: "Using a Stochastic Block Model to quantify differences in connectivity ipsi-laterally vs contra-laterally"
...
Determine if there exists a difference in the connectivity among the vertices in $C_1$ and $C_2$ within a particular modality, and between the communities $C_1$ and $C_2$, for the functional and diffusion connectomes. 
...
ggplot(data=p.dat, aes(x=dataset, y=p, color=dataset, group=dataset)) +
  geom_jitter() +
  ggtitle('Per-subject P-value (1 graph)') +
  xlab('Dataset') +
  ylab('p-value') +
